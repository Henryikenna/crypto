...
class _SelectCoinState extends State<SelectCoin> {
  late TrackballBehavior trackballBehaviour;
  ...
  Future<void> getChart() async {
    // String url =
    //     "https://api.coingecko.com/api/v3/${widget.selectItem.id}/markets?vs_currency=usd&order=market_cap_desc&per_page=100&page=1&sparkline=true&locale=en";
    String url =
        "https://api.coingecko.com/api/v3/coins/${widget.selectItem.id}/ohlc?vs_currency=usd&days=${days.toString()}";
  ...
  void initState() {
    getChart();
    trackballBehaviour = TrackballBehavior(
      enable: true,
